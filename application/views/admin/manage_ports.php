...
<a href="#list" data-toggle="tab" aria-expanded="true"> 
    ...
    <span class="hidden-xs"><b>PORTS LIST</b></span> 
</a> 
</li> 
<li class=""> 
<a href="#add" data-toggle="tab" aria-expanded="false"> 
    <span class="visible-xs"><i class="fa fa-user"></i></span> 
    <span class="hidden-xs"><b>ADD PORTS</b></span> 
</a> 
</li>
</ul> 
...
<tbody>
<?php if(isset($ports)): $sl=1; foreach ($ports as $value):?>
<tr>
    <td><?php echo $sl;?></td>
...
<div class="row">
        <div class="col-sm-12">
                <div class="card-box">
                        <?php echo form_open_multipart('setting/ports_management/create', array("class"=>"form-horizontal data-parsley-validate novalidate"));?>
                                <div class="form-group">
                                        <label for="port_name" class="col-sm-4 control-label">Port Name*</label>
                                        <div class="col-sm-7">
                                                <input type="text" name="port_name" id="userName" class="form-control" placeholder="Enter Port Name" required="" parsley-trigger="change" name="nick" data-parsley-id="4">
                                        </div>
                                </div>
                                <div class="form-group">
